...
###################################################################################################
def myLogisticRegressionCV(Cs, solver,penalty, fit_intercept, max_iter, cv, commName, full_data, oneside, ori_questionCount, aid2prior_q, total_answersWithVotes_ids, qid2involvedAnswerList, learnTau):
...
def myTrain(commIndex, commName, commDir, ori_questionCount, full_data_files, testingDataIndexListInFullData, log_file_name, roundIndex, variation, reg_alpha1, reg_alpha2, try_reg_strengthList, CVPgenerated, aid2prior_q, total_answersWithVotes_ids, qid2involvedAnswerList, total_sample_count, original_n_feature,sampled_comms, Interaction, Quadratic):
    ...
    if Interaction: # new model+Interaction generated
        result_file_name = f"semiSynthetic10_CVP{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_results.txt"
        trained_model_file_name = f'semiSynthetic10_CVP{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_model.sav'
        trained_withSKLEARN_model_file_name = f'semiSynthetic10_CVP{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withSKLEARN_model.pkl'
        result_withSKLEARN_file_name = f"semiSynthetic10_CVP{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withSKLEARN_results.txt"
        trained_withLBFGS_model_file_name = f'semiSynthetic10_CVP{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withLBFGS_model.sav'
        result_withLBFGS_file_name = f"semiSynthetic10_CVP{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withLBFGS_results.txt"
        plot_file_name = f'semiSynthetic10_CVP{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_Losses.png'
    elif Quadratic: # new model+Quadratic generated
        result_file_name = f"semiSynthetic10_CVP{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_results.txt"
        trained_model_file_name = f'semiSynthetic10_CVP{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_model.sav'
        trained_withSKLEARN_model_file_name = f'semiSynthetic10_CVP{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withSKLEARN_model.pkl'
        result_withSKLEARN_file_name = f"semiSynthetic10_CVP{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withSKLEARN_results.txt"
        trained_withLBFGS_model_file_name = f'semiSynthetic10_CVP{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withLBFGS_model.sav'
        result_withLBFGS_file_name = f"semiSynthetic10_CVP{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withLBFGS_results.txt"
        plot_file_name = f'semiSynthetic10_CVP{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_Losses.png'
    
    elif CVPgenerated:
        result_file_name = f"semiSynthetic10_CVP{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_results.txt"
        trained_model_file_name = f'semiSynthetic10_CVP{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_model.sav'
        trained_withSKLEARN_model_file_name = f'semiSynthetic10_CVP{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withSKLEARN_model.pkl'
        result_withSKLEARN_file_name = f"semiSynthetic10_CVP{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withSKLEARN_results.txt"
        trained_withLBFGS_model_file_name = f'semiSynthetic10_CVP{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withLBFGS_model.sav'
        result_withLBFGS_file_name = f"semiSynthetic10_CVP{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withLBFGS_results.txt"
        plot_file_name = f'semiSynthetic10_CVP{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_Losses.png'
    else: # new model generated
        result_file_name = f"semiSynthetic10_CVP{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_results.txt"
        trained_model_file_name = f'semiSynthetic10_CVP{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_model.sav'
        trained_withSKLEARN_model_file_name = f'semiSynthetic10_CVP{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withSKLEARN_model.pkl'
        result_withSKLEARN_file_name = f"semiSynthetic10_CVP{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withSKLEARN_results.txt"
        trained_withLBFGS_model_file_name = f'semiSynthetic10_CVP{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withLBFGS_model.sav'
        result_withLBFGS_file_name = f"semiSynthetic10_CVP{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_withLBFGS_results.txt"
        plot_file_name = f'semiSynthetic10_CVP{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_training_Losses.png'
    ...
    try:
        ...
        for batch in my_full_dataloader:
            ...
            #     print(f"doing cross validation reg_alpha pair ({reg_alpha1},{reg_alpha2}) for {commName}...")
            ...
            print(f"training sklearn lr with current reg_alpha pair ({reg_alpha1},{reg_alpha2}) for {commName}...")
...
def myFun(commIndex, commName, commDir,root_dir, roundIndex, variation, selected_reg_strengthList, try_reg_strengthList, CVPgenerated,sampled_comms, Interaction, Quadratic):
    ...
    log_file_name = "semiSynthetic10_newModelTraining_newTestingSplit_Log.txt"
    ...
    for reg_alpha1 in selected_reg_strengthList:
        ...
        for reg_alpha2 in try_reg_strengthList:
            ...
            if Interaction: # new model+Interaction generated
                resultFiles = [f'semiSynthetic10_newModelTraining{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_return.dict']
            elif Quadratic: # new model+Quadratic generated
                resultFiles = [f'semiSynthetic10_newModelTraining{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_return.dict']
            elif CVPgenerated:
                resultFiles = [f'semiSynthetic10_newModelTraining{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_posTau_return.dict']
            else: # new model generated
                resultFiles = [f'semiSynthetic10_newModelTraining{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_return.dict']
            ...
            if (coefs_lbfgs != None) or (coefs_sklearn != None):
                ...
                # save return dict
                if Interaction: # new model+Interaction generated
                    with open(intermediate_directory+f"/semiSynthetic10_newModelTraining{variation}_newModelInteractionGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_return.dict", 'wb') as outputFile:
                        pickle.dump(return_trainSuccess_dict, outputFile)
                elif Quadratic: # new model+Quadratic generated
                    with open(intermediate_directory+f"/semiSynthetic10_newModelTraining{variation}_newModelQuadraticGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_return.dict", 'wb') as outputFile:
                        pickle.dump(return_trainSuccess_dict, outputFile)
                elif CVPgenerated:
                    with open(intermediate_directory+f"/semiSynthetic10_newModelTraining{variation}_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_posTau_return.dict", 'wb') as outputFile:
                        pickle.dump(return_trainSuccess_dict, outputFile)
                else: # new model generated
                    with open(intermediate_directory+f"/semiSynthetic10_newModelTraining{variation}_newModelGenerated_round{roundIndex}_PriorRegAlpha({reg_alpha1})_regAlpha({reg_alpha2})_return.dict", 'wb') as outputFile:
                        pickle.dump(return_trainSuccess_dict, outputFile)
                    print( f"saved return_trainSuccess_dict of {commName}. tau_lbfgs:{tau_lbfgs},  conformity_lbfgs:{conformity_lbfgs}")

            # # save csv
            if Interaction: # new model+Interaction generated
                with open(root_dir +'/'+f'allComm_semiSynthetic10_newModel{variation}_newModelInteractionGenerated_round{roundIndex}_training_results.csv', 'a', newline='') as csvfile:
                    writer = csv.writer(csvfile, delimiter=',',
                                        quotechar='|', quoting=csv.QUOTE_MINIMAL)
                    if (coefs_sklearn != None) and (coefs_lbfgs != None):
                        writer.writerow( [commName,total_sample_count, reg_alpha1, reg_alpha2,coefs_sklearn[0], coefs_lbfgs[0],coefs,coefs_sklearn[1],coefs_lbfgs[1],coefs, mean(nus_sklearn), mean(nus_lbfgs),nus, mean(qs_sklearn), mean(qs_lbfgs),qs, tau_lbfgs, tau, CV_scores[try_reg_strengthList.index(reg_alpha2)][0],CV_scores[try_reg_strengthList.index(reg_alpha2)][1], CV_best_reg_alpha])
                    elif coefs_sklearn !=None:
                        writer.writerow( [commName,total_sample_count, reg_alpha1, reg_alpha2, coefs_sklearn[0], coefs_lbfgs,coefs, coefs_sklearn[1],coefs_lbfgs,coefs, mean(nus_sklearn), nus_lbfgs,nus, mean(qs_sklearn), qs_lbfgs,qs, tau_lbfgs, tau, CV_scores[try_reg_strengthList.index(reg_alpha2)][0],CV_scores[try_reg_strengthList.index(reg_alpha2)][1], CV_best_reg_alpha])
            elif Quadratic: # new model+Quadratic generated
                with open(root_dir +'/'+f'allComm_semiSynthetic10_newModel{variation}_newModelQuadraticGenerated_round{roundIndex}_training_results.csv', 'a', newline='') as csvfile:
                    writer = csv.writer(csvfile, delimiter=',',
                                        quotechar='|', quoting=csv.QUOTE_MINIMAL)
                    if (coefs_sklearn != None) and (coefs_lbfgs != None):
                        writer.writerow( [commName,total_sample_count, reg_alpha1, reg_alpha2,coefs_sklearn[0], coefs_lbfgs[0],coefs,coefs_sklearn[1],coefs_lbfgs[1],coefs, mean(nus_sklearn), mean(nus_lbfgs),nus, mean(qs_sklearn), mean(qs_lbfgs),qs, tau_lbfgs, tau, CV_scores[try_reg_strengthList.index(reg_alpha2)][0],CV_scores[try_reg_strengthList.index(reg_alpha2)][1], CV_best_reg_alpha])
                ...
                with open(root_dir +'/'+f'allComm_semiSynthetic10_newModel{variation}_round{roundIndex}_training_results.csv', 'a', newline='') as csvfile:
                    writer = csv.writer(csvfile, delimiter=',',
                                        quotechar='|', quoting=csv.QUOTE_MINIMAL)
                    if (coefs_sklearn != None) and (coefs_lbfgs != None):
                        writer.writerow( [commName,total_sample_count, reg_alpha1, reg_alpha2,coefs_sklearn[0], coefs_lbfgs[0],coefs,coefs_sklearn[1],coefs_lbfgs[1],coefs, mean(nus_sklearn), mean(nus_lbfgs),nus, mean(qs_sklearn), mean(qs_lbfgs),qs, tau_lbfgs, tau, CV_scores[try_reg_strengthList.index(reg_alpha2)][0],CV_scores[try_reg_strengthList.index(reg_alpha2)][1], CV_best_reg_alpha])
                ...
                with open(root_dir +'/'+f'allComm_semiSynthetic10_newModel{variation}_newModelGenerated_round{roundIndex}_training_results.csv', 'a', newline='') as csvfile:
                    writer = csv.writer(csvfile, delimiter=',',
                                        quotechar='|', quoting=csv.QUOTE_MINIMAL)
                    if (coefs_sklearn != None) and (coefs_lbfgs != None):
                        writer.writerow( [commName,total_sample_count, reg_alpha1, reg_alpha2,coefs_sklearn[0], coefs_lbfgs[0],coefs,coefs_sklearn[1],coefs_lbfgs[1],coefs, mean(nus_sklearn), mean(nus_lbfgs),nus, mean(qs_sklearn), mean(qs_lbfgs),qs, tau_lbfgs, tau, CV_scores[try_reg_strengthList.index(reg_alpha2)][0],CV_scores[try_reg_strengthList.index(reg_alpha2)][1], CV_best_reg_alpha])
...
def main():
    ...
    # # save csv
    if Interaction: # new model+Interaction generated
        with open(root_dir +'/'+f'allComm_semiSynthetic10_newModel{variation}_newModelInteractionGenerated_round{roundIndex}_training_results.csv', 'w', newline='') as csvfile:
            writer = csv.writer(csvfile, delimiter=',',
                                quotechar='|', quoting=csv.QUOTE_MINIMAL)
            writer.writerow( ["commName","totalSampleCount", "reg_alpha1","reg_alpha2", "lambda_sklearn", "lambda_torchLBFGS","lambda_torchSGD","beta_sklearn","beta_LBFGS", "beta_SGD", "nu_sklearn_mean", "nu_torchLBFGS_mean","nu_torchSGD_mean","q_sklearn_mean","q_torchLBFGS_mean","q_torchSGD_mean","tau_torchLBFGS", "tau_torchSGD", "cross validation learnedQ rankZscore to priorQ rankZscore average KL score", "cross validation voting prediction average accuracy score", "best cross validation reg_alpha"])
    elif Quadratic: # new model+Quadratic generated
        with open(root_dir +'/'+f'allComm_semiSynthetic10_newModel{variation}_newModelQuadraticGenerated_round{roundIndex}_training_results.csv', 'w', newline='') as csvfile:
            writer = csv.writer(csvfile, delimiter=',',
                                quotechar='|', quoting=csv.QUOTE_MINIMAL)
            writer.writerow( ["commName","totalSampleCount", "reg_alpha1","reg_alpha2", "lambda_sklearn", "lambda_torchLBFGS","lambda_torchSGD","beta_sklearn","beta_LBFGS", "beta_SGD", "nu_sklearn_mean", "nu_torchLBFGS_mean","nu_torchSGD_mean","q_sklearn_mean","q_torchLBFGS_mean","q_torchSGD_mean","tau_torchLBFGS", "tau_torchSGD", "cross validation learnedQ rankZscore to priorQ rankZscore average KL score", "cross validation voting prediction average accuracy score", "best cross validation reg_alpha"])

    elif CVPgenerated:
        with open(root_dir +'/'+f'allComm_semiSynthetic10_newModel{variation}_round{roundIndex}_training_results.csv', 'w', newline='') as csvfile:
            writer = csv.writer(csvfile, delimiter=',',
                                quotechar='|', quoting=csv.QUOTE_MINIMAL)
            writer.writerow( ["commName","totalSampleCount", "reg_alpha1","reg_alpha2", "lambda_sklearn", "lambda_torchLBFGS","lambda_torchSGD","beta_sklearn","beta_LBFGS", "beta_SGD", "nu_sklearn_mean", "nu_torchLBFGS_mean","nu_torchSGD_mean","q_sklearn_mean","q_torchLBFGS_mean","q_torchSGD_mean","tau_torchLBFGS", "tau_torchSGD", "cross validation learnedQ rankZscore to priorQ rankZscore average KL score", "cross validation voting prediction average accuracy score", "best cross validation reg_alpha"])
    else: # new model generated
        with open(root_dir +'/'+f'allComm_semiSynthetic10_newModel{variation}_newModelGenerated_round{roundIndex}_training_results.csv', 'w', newline='') as csvfile:
            writer = csv.writer(csvfile, delimiter=',',
                                quotechar='|', quoting=csv.QUOTE_MINIMAL)
            writer.writerow( ["commName","totalSampleCount", "reg_alpha1","reg_alpha2", "lambda_sklearn", "lambda_torchLBFGS","lambda_torchSGD","beta_sklearn","beta_LBFGS", "beta_SGD", "nu_sklearn_mean", "nu_torchLBFGS_mean","nu_torchSGD_mean","q_sklearn_mean","q_torchLBFGS_mean","q_torchSGD_mean","tau_torchLBFGS", "tau_torchSGD", "cross validation learnedQ rankZscore to priorQ rankZscore average KL score", "cross validation voting prediction average accuracy score", "best cross validation reg_alpha"])
    ...
    elapsed = format_time(time.time() - t0)
    # Report progress.
    print('semiSynthetic10_newModelTraining_newTestingSplit Done completely.    Elapsed: {:}.\n'.format(elapsed))
