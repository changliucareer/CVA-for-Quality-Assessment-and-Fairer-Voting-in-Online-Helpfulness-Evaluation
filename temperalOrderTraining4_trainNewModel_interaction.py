...
def myTrain(commIndex, commName, commDir, ori_questionCount, full_data, testingDataIndexListInFullData, log_file_name):
    ...
    #######################################################################
    ### training settings #######
    result_file_name = f"temperalOrderTraining4_trainNewModel_posTau_bias_interactionWithD_results.txt"
    trained_model_file_name = f'temperalOrderTraining4_trainNewModel_posTau_bias_interactionWithD_model.sav'
    trained_withFullData_model_file_name = f'temperalOrderTraining4_trainNewModel_withFullData_posTau_bias_interactionWithD_model.sav'
    result_withFullData_file_name = f"temperalOrderTraining4_trainNewModel_withFullData_posTau_bias_interactionWithD_results.txt"
    plot_file_name = f'temperalOrderTraining4_trainNewModel_posTau_bias_interactionWithD_Losses.png'
...
def myFun(commIndex, commName, commDir):
    ...
    log_file_name = "temperalOrderTraining4_newModel_bias_interactionWithD_Log.txt"
    ...
    # save return dict
    with open(intermediate_directory+f"/temperalOrderTraining4_newModel_bias_interactionWithD_return.dict", 'wb') as outputFile:
...
def main():
    ...
    elapsed = format_time(time.time() - t0)
    # Report progress.
    print('temperalOrderTraining4 train new Model with interaction term  Done completely.    Elapsed: {:}.\n'.format(elapsed))
