...
def myFun(commIndex, commName, commDir):
    ...
    log_file_name = "predictionAnalysis7_hardSamples_negLogLikelyhoods_CVP_Log.txt"
    ...
    resultFiles = ['predictionAnalysis7_CVP_return.dict']
    ...
    for i in range(3):
        ...
        trainedModelDir = model_folder + f'/predictionAnalysis3_negLogLikelyhoods_CVP_trainWith{trainingPercentage}_model.sav'
    ...
    # save return dict
    with open(intermediate_directory+f"/predictionAnalysis7_CVP_return.dict", 'wb') as outputFile:
...
def main():
    ...
    # Report progress.
    print('prediction analysis 7 hard samples NLLs for CVP  Done completely.    Elapsed: {:}.\n'.format(elapsed))
